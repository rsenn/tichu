...
/* $Id: mixer.h,v 1.3 2005/05/22 01:25:47 smoli Exp $ */
...
extern DECLSPEC SDL_AudioSpec *SDLCALL Mix_OpenAudio(int frequency, Uint16 format, int channels,
                                                     int chunksize);
...
extern DECLSPEC double SDLCALL Mix_GetMusicPosition(void);
extern DECLSPEC double SDLCALL Mix_GetMusicLength(void);
