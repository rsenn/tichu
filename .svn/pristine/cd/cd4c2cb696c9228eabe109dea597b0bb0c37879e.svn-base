 ...
 * MA 02111-1307, USA
 * 
 * $Id: dlink.h,v 1.32 2005/01/17 19:09:50 smoli Exp $
 */
 ...
 * Global variables                                                           *
 * -------------------------------------------------------------------------- */
extern int                 dlink_log;
extern struct sheap        dlink_heap;     /* block heap on which nodes are stored */
extern uint32_t            dlink_count;    /* dlink statistics */
extern int                 dlink_dirty;
 ...
 * Destroy heap                                                               *
 * -------------------------------------------------------------------------- */
extern void                dlink_shutdown    (void);

/* -------------------------------------------------------------------------- *
 * Garbage collect                                                            *
 * -------------------------------------------------------------------------- */
extern void                dlink_collect     (void);
  
/* -------------------------------------------------------------------------- *
 * Allocate a new dlink node                                                  *
 * -------------------------------------------------------------------------- */
extern struct node        *dlink_node_new    (void);
 ...
 * Frees a dlink node                                                         *
 * -------------------------------------------------------------------------- */
extern void                dlink_node_free   (struct node *nptr);
 ...
 * -------------------------------------------------------------------------- */
extern void                dlink_add_head    (struct list *lptr,
                                              struct node *nptr,
                                              void        *ptr);
#ifndef DARWIN
 ...
 * <ptr>                    - a user-defined pointer                          *
 * -------------------------------------------------------------------------- */
extern void                dlink_add_tail    (struct list *lptr,
                                              struct node *nptr, 
                                              void        *ptr);
 ...
 * <ptr>                    - a user-defined pointer                          *
 * -------------------------------------------------------------------------- */
extern void                dlink_add_before  (struct list *lptr,
                                              struct node *nptr,
                                              struct node *before,
                                              void        *ptr);
 ...
 * <ptr>                    - a user-defined pointer                          *
 * -------------------------------------------------------------------------- */
extern void                dlink_add_after   (struct list *lptr,
                                              struct node *nptr,
                                              struct node *after, 
                                              void        *ptr);
 ...
 * -------------------------------------------------------------------------- */
extern void                dlink_delete      (struct list *lptr, 
                                              struct node *nptr);
 ...
 * -------------------------------------------------------------------------- */
extern struct node        *dlink_find        (struct list *lptr, 
                                              void        *ptr);
#ifndef DARWIN
 ...
 * -------------------------------------------------------------------------- */
extern struct node        *dlink_find_delete (struct list *lptr, void *ptr);
 ...
 * -------------------------------------------------------------------------- */
extern struct node        *dlink_index       (struct list *lptr,
                                              size_t       index);
 ...
 * -------------------------------------------------------------------------- */
extern void                dlink_destroy     (struct list *lptr);
 ...
 * -------------------------------------------------------------------------- */
extern void                dlink_swap        (struct list *lptr, 
                                              struct node *nptr1,
                                              struct node *nptr2);

#if 0
extern inline void         dlink_swap        (struct list *lptr, 
                                              struct node *nptr1,
                                              struct node *nptr2)
{
  struct node *n1temp;
 ...
 * -------------------------------------------------------------------------- */
extern void              dlink_move_head     (struct list *from,
                                              struct list *to);
 ...
 * <to>                     - list to move nodes to                           *
 * -------------------------------------------------------------------------- */
extern void                dlink_move_tail   (struct list *from,
                                              struct list *to);
 ...
 * -------------------------------------------------------------------------- */
extern void                dlink_copy        (struct list *from, 
                                              struct list *to);
...
/* -------------------------------------------------------------------------- *
  * -------------------------------------------------------------------------- */
extern uint32_t            dlink_count_nodes (struct list *lptr);
  
/* -------------------------------------------------------------------------- *
 * Dump dlink statistics.                                                     *
 * -------------------------------------------------------------------------- */
extern void                dlink_dump        (void);
